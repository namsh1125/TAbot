    ...
    while True:
        ...
        if not results.multi_hand_landmarks:
            ...
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                # 엄지를 제외한 나머지 4개 손가락의 마디 위치 관계를 확인하여 플래그 변수를 설정. 손가락을 일자로 편 상태인지 확인.
                ...
                # 손가락 위치 확인한 값을 사용하여 가위,바위,보 중 하나를 출력.
                ...
                if index_finger_state == 0 and middle_finger_state == 0 and ring_finger_state == 0 and pinky_finger_state == 0:
                    ...
                    for image in images:
                        ...
                        current_image_encoded = face_recognition.face_encodings(current_image)[0]  # 파일에서 가져온 이미지에서 얼굴 특징 추출하기
